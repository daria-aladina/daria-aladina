...
<ul>
  <li>Аналитик данных с математическим образованием и 2+ годами опыта в продуктовой команде
  на международных IT-проектах
  
  <li>Получила степень бакалавра по специальности "Прикладная математика и информатика" в 2024 году (КубГУ, ФКТиПМ)
  <li> Специализируюсь на поиске инсайтов в пользовательском поведении и автоматизации
